...
static double __pyx_f_4algo_match(PyObject *, PyObject *, int __pyx_skip_dispatch); /*proto*/
...
static PyObject *__pyx_pf_4algo_match(CYTHON_UNUSED PyObject *__pyx_self, PyObject *__pyx_v_base, PyObject *__pyx_v_other); /* proto */
...
static PyObject *__pyx_pw_4algo_1match(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static double __pyx_f_4algo_match(PyObject *__pyx_v_base, PyObject *__pyx_v_other, CYTHON_UNUSED int __pyx_skip_dispatch) {
 ...
 */
  ...
  __Pyx_WriteUnraisable("algo.match", __pyx_clineno, __pyx_lineno, __pyx_filename, 1, 0);
  __pyx_r = 0;
  __pyx_L0:;
...
/* Python wrapper */
static PyObject *__pyx_pw_4algo_1match(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static char __pyx_doc_4algo_match[] = "\n    Based on the data structure, calculate that how much of the time that there is\n    some speech going on in base, there is a subtitle in other.\n    ";
static PyObject *__pyx_pw_4algo_1match(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  __pyx_L3_error:;
  __Pyx_AddTraceback("algo.match", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  ...
  __pyx_r = __pyx_pf_4algo_match(__pyx_self, __pyx_v_base, __pyx_v_other);
...
static PyObject *__pyx_pf_4algo_match(CYTHON_UNUSED PyObject *__pyx_self, PyObject *__pyx_v_base, PyObject *__pyx_v_other) {
  ...
  __pyx_t_1 = PyFloat_FromDouble(__pyx_f_4algo_match(__pyx_v_base, __pyx_v_other, 0)); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 15, __pyx_L1_error)
...
static PyMethodDef __pyx_methods[] = {
  {"match", (PyCFunction)(void*)(PyCFunctionWithKeywords)__pyx_pw_4algo_1match, METH_VARARGS|METH_KEYWORDS, __pyx_doc_4algo_match},
  {0, 0, 0, 0}
};
